<div align="center">
  ...
  <table width="100%" style="background:#121215; border:1px solid #27272A; border-radius:12px; padding:24px; text-align:left">
    <tr>
      <td>
    ...
    <td width="50%" valign="top" style="padding:12px">
      <div style="background:#121215; border:1px solid #27272A; border-radius:12px; padding:20px; height:100%">
        ...
        <p style="font-family:sans-serif; font-size:13px; color:#9DA3AE; line-height:1.6; margin-bottom:16px">
          Full-stack PWA digitizing National Cadet Corps operations — syllabus tracking, drill exam simulator, wing analytics, and offline sync. Backed by 16 Supabase SQL migrations with Row-Level Security.
        </p>
